<template>
    <div>
        ...
        <!-- <div class="d-flex bg-white py-2 mt-4 mb-4" v-for="feed in feeds">
    ...
    <div class="d-flex flex-column justify-content-end my-1 ml-4">
        ...
        <div v-if="feeds == ''" class="d-flex bg-white py-2 mt-4 mb-4 justify-content-center">Your post is empty.</div>
        <!-- Show Feed Modal -->
        <modal name="feed-details" transition="pop-out" width="60%" height="auto">
            ...
            <!-- <img src="/images/relationship.svg" width="20">
